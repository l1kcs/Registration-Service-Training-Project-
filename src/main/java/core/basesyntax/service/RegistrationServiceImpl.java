...
public class RegistrationServiceImpl implements RegistrationService {
    ...
    public User register(User user) {
        ...
        if (user.getAge() < 18) {
            throw new IllegalDataException("org.example.model.User's age is at least 18 y.o.");
        }
        if (storageDao.get(user.getLogin()) != null) {
            throw new IllegalDataException("org.example.model.User with this login already exists");
        }
